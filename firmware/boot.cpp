...
bool show()
{
    ...
    fprintf_P(&max7456::stream, PSTR("MultiOSD %u.%u"), VERSION >> 8, VERSION);
    for (uint8_t x = 0; x < max7456::right; x++)
        max7456::put(x, 2, 0x1a);
    max7456::puts_p(max7456::right - 3, 1, PSTR(OSD_SYMBOL_LOGO));
